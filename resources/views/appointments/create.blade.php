...
<div class="max-w-3xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <a href="{{ route('appointments.index') }}" class="inline-flex items-center text-gray-600 hover:text-gray-900 mb-4">
    ...
    <form action="{{ route('appointments.store') }}" method="POST" class="space-y-6">
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('appointments.index') }}" class="px-6 py-2 border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition">
                Cancel
            </a>
